...
stopwords = [i.strip() for i in open('./fixes-zh.txt', "r", encoding = 
                                     "utf-8").readlines()]
...
test2 = topic_model.visualize_distribution(probs[100], min_probability=0.002)
...
test3 = topic_model.visualize_hierarchy(top_n_topics=40)
